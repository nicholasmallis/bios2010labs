...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">2518 cal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">1781 cal</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">1620 cal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">1606 cal</button></div>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">42.42 g</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">24.16 g</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">28.26 g</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">46.36 g</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Between which values of the Theoretical Quantiles is the data normal?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Between -1.5 and 1 the values are close to normal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">There are no departures for normality</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Below -1 and above 1 the values are close to normal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">It is not normal over any values of the theoretical quantiles</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Which values match the results of your test?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = -5.46, df = 173, p-value &lt; 2.2e+16</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = -3835.7, df = 172, p-value &lt; 2.2e-16</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = -42.42, df = 172, p-value &lt; 1.2e-32</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">t = -15.46, df = 172, p-value &lt; 2.2e-16</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>What was the mean of the total calorie intake?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">1939.103 cal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">1734.931 cal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">1242.842 cal</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">1619.873 cal</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>What is the conclusion from the results of the test?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Since p &lt; $\alpha$, we reject the null hypothesis, and conclude that there is evidence the true mean is not 2000 calories.</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Since p &gt; $\alpha$, we fail to reject the null hypothesis, and conclude that there is no evidence the true mean is not 2000 calories.</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Since p &lt; $\alpha$, we reject the null hypothesis, and conclude that there is evidence the true mean is greater than 2000 calories.</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Since p &lt; $\alpha$, we fail to reject the null hypothesis, and conclude that there is evidence the true mean is less than 2000 calories.</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 4</h4><p>What is the 95% confidence interval for the mean total intake of calories?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (1517.269, 1768.420)</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">95% CI (1571.339, 1668.407)</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (1031.671, 1996.710)</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (561.273, 1340.007)</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>What is the mean and max of the new ExcFat variable?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">$\mu$ = 17.420, max = 41.360</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">$\mu$ = 12.770, max = 26.915</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">$\mu$ = 15.970, max = 43.975</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">$\mu$ = 19.709, max = 34.795</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Between which values of the Theoretical Quantiles is the ExcFat data normal?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">There are no departures from normality</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Between -1.5 and 2 the values are close to normal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">above 1 all the values are normal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">It is not normal over any values of the theoretical quantiles</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>Which values match the results of your test?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = 5.46, df = 173, p-value &lt; 2.2e+15</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = 3835.7, df = 172, p-value &lt; 2.2e-16</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">t = 24.593, df = 172, p-value &lt; 2.2e-16</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = 15.46, df = 171, p-value &lt; 2.2e-12</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>What was the mean of the total excess fat?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">15.96951 g</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">17.34931 g</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">12.42842 g</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">16.19873 g</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 4</h4><p>What is the conclusion from the results of the test?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Since p &lt; $\alpha$, we reject the null hypothesis, and conclude that there is evidence the true mean is not 0 grams of excess fat.</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Since p &gt; $\alpha$, we fail to reject the null hypothesis, and conclude that there is no evidence the true mean is not 0 grams of excess fat.</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Since p &lt; $\alpha$, we reject the null hypothesis, and conclude that there is evidence the true mean is greater than 0 grams of excess fat.</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Since p &lt; $\alpha$, we fail to reject the null hypothesis, and conclude that there is evidence the true mean is less than 0 grams of excess fat.</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 5</h4><p>What is the 95% confidence interval for the mean total intake of calories?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (15.17269, 17.68420)</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (15.71339, 16.68407)</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">95% CI (14.68776, 17.25125)</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (5.612730, 13.40007)</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
## Summary
...
![](../tutorials/Lab10/images/1samptest.jpg)
