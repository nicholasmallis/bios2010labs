...
```{=html}
<div class="lab-widget" data-normal-curves>
  <div class="lab-widget-controls">
    <label><span>Green Mean</span><input type="range" min="-100" max="100" value="0" step="0.5" data-normal-mean="green"><output data-normal-mean-output="green">0.0</output></label>
    <label><span>Green Standard Deviation</span><input type="range" min="0.5" max="20" value="1" step="0.5" data-normal-sd="green"><output data-normal-sd-output="green">1.0</output></label>
    <label><span>Blue Mean</span><input type="range" min="-100" max="100" value="0" step="0.5" data-normal-mean="blue"><output data-normal-mean-output="blue">0.0</output></label>
    <label><span>Blue Standard Deviation</span><input type="range" min="0.5" max="20" value="3" step="0.5" data-normal-sd="blue"><output data-normal-sd-output="blue">3.0</output></label>
    <label><span>Red Mean</span><input type="range" min="-100" max="100" value="0" step="0.5" data-normal-mean="red"><output data-normal-mean-output="red">0.0</output></label>
    <label><span>Red Standard Deviation</span><input type="range" min="0.5" max="20" value="5" step="0.5" data-normal-sd="red"><output data-normal-sd-output="red">5.0</output></label>
    <label><span>X Axis Minimum</span><input type="range" min="-175" max="175" value="-15" step="1" data-normal-x-min><output data-normal-x-min-output>-15</output></label>
    <label><span>X Axis Maximum</span><input type="range" min="-175" max="175" value="15" step="1" data-normal-x-max><output data-normal-x-max-output>15</output></label>
  </div>
  <svg class="lab-plot" viewBox="0 0 760 420" role="img" aria-label="Interactive normal distribution curves"></svg>
</div>
```
