...
<div class="lab-widget lab-normal-curves-widget" data-normal-curves>
  ...
  <div class="lab-normal-plot-wrap">
    <svg class="lab-plot lab-normal-curves-plot" viewBox="0 0 760 540" role="img" aria-label="Interactive normal distribution curves"></svg>
  </div>
</div>
```

The plotting approach for this normal curve activity was adapted from an example by DK Math Stats: <https://steemit.com/programming/@dkmathstats/plotting-probability-distribution-functions-in-r-using-ggplot2>.
...
<button type="button" class="lab-answer" data-correct="true">Yes, It is more probable that a man has a weight greater than 167lbs</button>
