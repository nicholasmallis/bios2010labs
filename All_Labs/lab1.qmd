...
webr:
  ...
  resources:
    - ../tutorials/Lab1/www/clean_heart_failure.Rda
    - ../tutorials/Lab1/www/faithful.csv
    - ../tutorials/Lab1/www/heart.csv
    - ../tutorials/Lab1/www/heartDataDictionary.txt
---
...
heart_failure <- read.csv("tutorials/Lab1/www/heart.csv")

old_faithful <- read.csv("tutorials/Lab1/www/faithful.csv")
```

<div data-guided-lab data-lab-title="Lab 1"></div>
...
Below is an interactive histogram of eruption duration of Old Faithful a famous geyser in Yellowstone national park. Want to see an eruption? Check out the [live stream](https://www.nps.gov/yell/learn/photosmultimedia/webcams.htm). This example is from the RStudio [shiny gallery](http://shiny.rstudio.com/gallery/) follow the link if you want to see more interactive figures. 
...
```{=html}
<div class="lab-widget lab-histogram" data-faithful-histogram data-csv="../tutorials/Lab1/www/faithful.csv">
  <div class="lab-widget-controls">
    <label>
      <span>Number of bins in histogram (approximate)</span>
      <select data-hist-bins>
    ...
    <label class="lab-check">
      <input type="checkbox" data-hist-rug>
      <span>Show individual observations</span>
    </label>
    <label class="lab-check">
      <input type="checkbox" data-hist-density>
      <span>Show density estimate</span>
    </label>
    <label data-density-control hidden>
      <span>Bandwidth adjustment</span>
      <input type="range" min="0.2" max="2" step="0.2" value="1" data-hist-bandwidth>
      <output data-hist-bandwidth-value>1.0</output>
    </label>
  </div>
  <svg class="lab-plot" viewBox="0 0 760 360" role="img" aria-label="Histogram of Old Faithful eruption duration"></svg>
</div>
```
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>What is the longest duration of an Old Faith eruption?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Make sure you are looking at the eruptions column">3.6</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="This is the median for eruptions">4</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Great Job!">5.1</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Make sure you are looking at the eruptions column">96</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>What is the mean duration of an Old Faith eruption?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Excellent Work!">3.488</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="This is the median for eruptions">4</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="This is the mean for waiting">70.9</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Close this is Q3 for eruptions you want the mean">4.45</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
R and the corresponding development software RStudio is free, and both have a great user community, so if you ever need to do some data analysis for another class, it is a great place to start ( [Download R](https://cloud.r-project.org/), [Download Rstudio](https://www.rstudio.com/products/rstudio/download/)).  
...
```{=html}
<div class="lab-widget lab-data-explorer" data-heart-table data-csv="../tutorials/Lab1/www/heart.csv">
  <div class="lab-widget-controls">
    <label>
      <span>Sex</span>
      <select data-heart-filter="sex"></select>
    </label>
    <label>
      <span>Fasting Blood Sugar &gt;120 mg/dl</span>
      <select data-heart-filter="fbs"></select>
    </label>
    <label>
      <span>Exercise Induced Angina</span>
      <select data-heart-filter="exang"></select>
    </label>
  </div>
  <p class="lab-table-count" data-heart-count></p>
...
**Don't forget to write your answers down so that you can answer the questions on the eLC quiz for this lab.**
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>What is the age of the oldest male included in the data?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Make sure the arrow is pointing down, Sex = 1, and the rest are set to All">59</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Make sure the arrow is pointing down, Sex = 1, and the rest are set to All">93</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="You are a fast learner!">77</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Make sure the arrow is pointing down, Sex = 1, and the rest are set to All">76</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 4</h4><p>What is the highest cholesterol value in the data?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Keep up the good work!">564</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Set everything to All and make sure the arrow is pointing down">300</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Set everything to All and make sure the arrow is pointing down">266</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Set everything to All and make sure the arrow is pointing down">274</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 5</h4><p>How many women have a fasting blood sugar &gt; 120 mg/dl?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Make sure you have Sex=0, and Fasting Blood Sugar=1. The number of entries are at the bottom of the table">200</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Make sure you have Sex=0, and Fasting Blood Sugar=1. The number of entries are at the bottom of the table">65</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Now you have figured it out!">12</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Make sure you have Sex=0, and Fasting Blood Sugar=1. The number of entries are at the bottom of the table">33</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 6</h4><p>How many patients are included in the data set?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="The three variables should be on ALL. The number of entries is at the bottom left of the table">204</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="The three variables should be on ALL. The number of entries is at the bottom left of the table">650</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="The three variables should be on ALL. The number of entries is at the bottom left of the table">258</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="I am not even surprised!">303</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
## Data Summaries
...
**Don't forget to write your answers down so that you can answer the questions on the eLC quiz for this lab.**
<section class="lab-quiz" data-lab-quiz><h4>Question 7</h4><p>What is the mean age of the patients?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="55 is the median you want the mean">55.0</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="61 is Q3 you want the mean">61.0</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Sensational!">54.37</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="77 is the max you want the mean">77.0</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 8</h4><p>What is the bin width for the age histogram?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Wonderful!">5</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Close don&#x27;t forget to include the starting value of the interval">4</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Close but there are 2 bins in that width">10</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="How many bins are between 30 and 40?">8</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 9</h4><p>Which age group has the most patients based on the histogram?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Look at results from exercise 5, Which bar is the tallest?">30-45</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Look at results from exercise 5, Which bar is the tallest?">75-80</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Keep it up!">55-60</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Look at results from exercise 5, Which bar is the tallest?">40-55</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 10</h4><p>What is the lowest cholesterol value recorded for a patient?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="You are one with the data!">126</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Make sure the output is for the `chol` variable. You want the Min: from the summary output">100</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Make sure the output is for the `chol` variable. You want the Min: from the summary output">211</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Make sure the output is for the `chol` variable. You want the Min: from the summary output">97</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
## Summary 
...
![](../tutorials/Lab1/images/conditional_risk.png)
