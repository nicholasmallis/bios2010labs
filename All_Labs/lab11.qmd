...
```{=html}
<div class="lab-widget" data-tennis-widget data-csv="../tutorials/Lab11/www/Tennis3_clean.csv">
  ...
  <div class="lab-split-widget">
    <div>
      ...
      <svg class="lab-plot" viewBox="0 0 760 460" role="img" aria-label="Plot of selected Tennis3 variable"></svg>
    </div>
    <div>
