...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Which variables need to have a normal distribution for the paired t test? (Select all the apply)</p><p class="quiz-note"> Select all correct answers.</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Age</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Motrin1</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Motrin2</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Motrin3</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Placebo1</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Placebo2</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Placebo3</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Delta1</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Delta2</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Delta3</button></div>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Yes, our sample size is &gt; 40</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No, we don&#x27;t meet the requirements of the CLT</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>Does our data meet the simple random sample requirement?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Yes. It is a biologic process and the treatment is randomized</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes. They are randomized</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No. We shouldn&#x27;t do the test</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">You don&#x27;t need a random sample for the paired t test</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = 12.101, df = 82, p-value = 1.253e-12</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = 9.1163, df = 81, p-value = 9.983e-04</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">t = 4.1061, df = 81, p-value = 9.551e-05</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = 2.6041, df = 83, p-value = 3.511e-05</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>What is the 95% confidence interval for the mean difference between the treatment groups?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">95% CI (0.4337173, 1.2492095)</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (0.6237121, 1.9220692)</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (0.3637334, 2.1492462)</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (0.3433317, 1.4920852)</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>Can you infer that Motrin causes a change in pain level while playing tennis?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Yes, the patients were randomized to treatment groups.</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No, the sample was made up of volunteers</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, we used the right test</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No, the sample was two small</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>What is the test statistic, degrees of freedom, and p-value of the test?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = 4.3157, df = 83, p-value = 0.1201424</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">t = 4.0417, df = 81, p-value = 0.0001201</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = 3.1954, df = 80, p-value = 0.3400242</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">t = 4.0417, df = 82, p-value = 0.5487313</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>What is the 95% confidence interval for the mean difference between the treatment groups?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (0.3216711, 2.2334603)</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (0.2210420, 1.2375043)</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">95% CI (0.4210623, 1.3245043)</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">95% CI (0.4210323, 1.2375043)</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>Can you infer that Motrin causes a change in pain level after playing tennis?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No, the sample was made up of volunteers</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, we used the right test</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Yes, the patients were randomized to treatment groups</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No, the sample was two small</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Based on the plot did everyone report having less pain with Motrin compared to placebo?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, all the participants had higher scores when on Motrin</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">No, some participants had higher scores when on placebo and others had no change</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No, there are only 23 lines so not all the participants are shown</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, everyone knows Motrin reduces pain</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
## Summary
...
![](../tutorials/Lab11/images/pvalue_meme.jpg)
