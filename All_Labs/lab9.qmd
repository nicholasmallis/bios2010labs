...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">True</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">False</button></div>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Uniform</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Binomial</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Normal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Poisson</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Uniform</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Binomial</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Normal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Poisson</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Uniform</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Binomial</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Normal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Poisson</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Binomial</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Normal</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Poisson</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
## Random Samples
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>What is the smallest sample size gives you an absolute difference less than 1 for all the variables?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">n = 122 Students</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">n = 3 Students</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">n = 21 Students</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">n = 57 Students</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>Set the sample size to 100. Record the absolute difference for all the variables. Now set the sample size to 10,000. For all the variables what are differences between the absolute differences of the two random samples?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">0.009, 0.095, 0.239, 0.517, 0.077</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">0.006, 0.905, 0.923, 0.157, 0.577</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">0.029, 0.193, 0.536, 0.527, 0.127</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">0.927, 0.346, 0.749, 0.187, 0.420</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>It is worth the extra time and money to collect the data for a sample of 10,000 compared to 100.</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">True</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">False</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Look at the plots for all the variables. For all the variables what happens to the estimates as the sample size increases? (X axis 1 to 5000)</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Nothing worth mentioning</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">The graph is different for all the variables</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">There is not a clear pattern</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">The estimates become less variable and get closer to the parameter value as the sample size increases</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>Why is the estimated mean age very close to the true mean even with a very small sample? (X axis to 1 and 100)</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">It is impossible to know</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Just lucky</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">The range of possible values is small</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Mostly do to biased sampling</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>Why does the estimated mean weight take so long to before the red line is consistently near the true mean? (X axis to 1 and 1000)?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">The weight variable has the most variation</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">weight is hard to measure accurately</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Because no one reported their actual weight</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Bad luck</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Does it work for Age? (Sample size:40, Repeated Samples:10000)</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes it looks normal, but age is already normally distributed</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No the curve is not even approximately bell shaped, and age is uniformly distributed</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Yes it looks normal, even though age is uniformly distributed</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">There is not enough information to say</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>Does it work for Weight? (Sample size:40, Repeated Samples:10000)</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">There is not enough information to say</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Yes it looks normal, weight has a skewed distributed</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No the curve is not even approximately bell shaped, and weight is skewed</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes it looks normal, but weight is uniformly distributed</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>Does it work for Height? (Sample size:40, Repeated Samples:10000)</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No the curve is not even a little bell shaped</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes it looks normal, even though height seems to have a Poisson distribution</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">There is not enough information to say</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Yes it looks normal, height is normally distributed</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 4</h4><p>Does it work for Classes? (Sample size:40, Repeated Samples:10000)</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Yes it looks normal, even though the classes variable is Poisson distributed</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No one really knows</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes it looks normal, but classes was already normally distributed</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Look more like a negative binomial distribution</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 5</h4><p>Does it work for Sex? (Sample size:40, Repeated Samples:10000)</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No!</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Kinda of normal, it is a little jagged</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes it looks perfectly normal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Still looks like a binomial distribution</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
## Summary
...
![](../tutorials/Lab9/images/meanception.jpg)
