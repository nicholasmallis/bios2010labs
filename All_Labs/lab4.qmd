...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">continuous</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">discrete</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">nominal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">ordinal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">dichotomous</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">numeric</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">factor</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">integer</button></div>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">continuous</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">discrete</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">nominal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">ordinal</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">dichotomous</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">numeric</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">factor</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">integer</button></div>
<button type="button" class="lab-check-answer" data-check-answers>Check Answers</button>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">continuous</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">discrete</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">nominal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">ordinal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">dichotomous</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">numeric</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">factor</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">integer</button></div>
<button type="button" class="lab-check-answer" data-check-answers>Check Answers</button>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">age</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">sex</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">trestbps</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">chol</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">fbs</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">thalach</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">exang</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">oldpeak</button></div>
<button type="button" class="lab-check-answer" data-check-answers>Check Answers</button>
<div class="lab-feedback" aria-live="polite"></div></section>
## Data Cleaning R
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, knowing the mean and median is always important</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">No, counts or relative frequencies should be shown</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, Q1 and Q2 should always been shown</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 11</h4><p>How many patients have exercise induced angina?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">99</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">204</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">105</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">303</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, The median is higher for those with exang = Yes</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">No, They are very similar</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, The median is lower for those with exang = Yes</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No, The box plot shows the means are different</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, knowing the mean and median is always important</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No, counts or relative frequencies should be shown</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Yes, now it shows the frequency and relative frequency</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 14</h4><p>How many patients have a fasting blood sugar &gt; 120mg/dl?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">45</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">258</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">153</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">330</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Age</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Serum Cholesterol</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Maximum Recorded Heart Rate</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Resting Blood Pressure</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Exercise Induced ST Depression Relative to Rest</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">32.5-37.5</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">52.5-57.5</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">67.5-72.5</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">57.5-62.5</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
## Summary
