...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Select the data type and corresponding R data type for: <strong>age</strong></p><p class="quiz-note"> Select all correct answers.</p>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>Select the data type and corresponding R data type for: <strong>sex</strong></p><p class="quiz-note"> Select all correct answers.</p>
...
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">integer</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>Select the data type and corresponding R data type for: <strong>trestbps</strong></p><p class="quiz-note"> Select all correct answers.</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">continuous</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">discrete</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">nominal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">ordinal</button>
...
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">integer</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 4</h4><p>Select the data type and corresponding R data type for: <strong>chol</strong></p><p class="quiz-note"> Select all correct answers.</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">continuous</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">discrete</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">nominal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">ordinal</button>
...
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">integer</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 5</h4><p>Select the data type and corresponding R data type for: <strong>fbs</strong></p><p class="quiz-note"> Select all correct answers.</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">continuous</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">discrete</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">nominal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">ordinal</button>
...
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">integer</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 6</h4><p>Select the data type and corresponding R data type for: <strong>thalach</strong></p><p class="quiz-note"> Select all correct answers.</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">continuous</button>
...
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 7</h4><p>Select the data type and corresponding R data type for: <strong>exang</strong></p><p class="quiz-note"> Select all correct answers.</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">continuous</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">discrete</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">nominal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">ordinal</button>
...
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">integer</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 8</h4><p>Select the data type and corresponding R data type for: <strong>oldpeak</strong></p><p class="quiz-note"> Select all correct answers.</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">continuous</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">discrete</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">nominal</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">ordinal</button>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Is the summary for sex in chunk 2 correct?</p>
...
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>How many patients have exercise induced angina?</p>
...
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>Is the distribution of resting blood pressure different when stratified by exang?</p>
...
```
### Quiz: Question 13-15
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Is the summary for sex in this table correct?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, knowing the mean and median is always important</button>
...
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>How many patients have a fasting blood sugar &gt; 120mg/dl?</p>
...
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>Among the continuous and discrete variables which is the most variable?</p>
