...
```
### Quiz: Questions 4-6
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Are there outliers in the cholesterol variable?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, to the left</button>
...
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>What is the what is the highest non-outlier value for cholesterol?</p>
...
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>What is the IQR for cholesterol?</p>
...
```
### Quiz: Questions 7-9
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>What is the range for trestbps?</p>
...
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>Is the distribution of trestbps skewed?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, to the left</button>
<button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">No</button>
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Yes, to the right</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>What is the IQR for trestbps?</p>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Is the distribution of oldpeak skewed?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false" data-feedback="Try again.">Yes, to the left</button>
...
<button type="button" class="lab-answer" data-correct="true" data-feedback="Correct.">Yes, to the right</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>What is the median for oldpeak?</p>
...
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>What is the IQR of oldpeak?</p>
...
<section class="lab-quiz" data-lab-quiz><h4>Question 1</h4><p>Does cholesterol seem to be different for males and females?</p>
...
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 2</h4><p>Is there any difference in resting blood pressure for patients based on fbs?</p>
