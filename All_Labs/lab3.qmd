...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false">Yes, to the left</button>
<button type="button" class="lab-answer" data-correct="true">No, seems pretty centered</button>
<button type="button" class="lab-answer" data-correct="false">Yes, to the right</button></div>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true">55</button>
<button type="button" class="lab-answer" data-correct="false">54.37</button>
<button type="button" class="lab-answer" data-correct="false">47.5</button>
<button type="button" class="lab-answer" data-correct="false">56</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 3</h4><p>What is the IQR for age?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false">29</button>
<button type="button" class="lab-answer" data-correct="false">61</button>
<button type="button" class="lab-answer" data-correct="false">47.5</button>
<button type="button" class="lab-answer" data-correct="true">13.5</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
```{webr}
#| edit: true
#| min-lines: 4
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false">Yes, to the left</button>
<button type="button" class="lab-answer" data-correct="false">No</button>
<button type="button" class="lab-answer" data-correct="true">Yes, to the right</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 5</h4><p>What is the highest non-outlier value for cholesterol?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true">Around 350</button>
<button type="button" class="lab-answer" data-correct="false">Around 290</button>
<button type="button" class="lab-answer" data-correct="false">Around 550</button>
<button type="button" class="lab-answer" data-correct="false">There are no outliers</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 6</h4><p>What is the IQR for cholesterol?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false">438</button>
<button type="button" class="lab-answer" data-correct="false">-63.5</button>
<button type="button" class="lab-answer" data-correct="false">126</button>
<button type="button" class="lab-answer" data-correct="true">63.5</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
```{webr}
#| edit: true
#| min-lines: 4
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false">120</button>
<button type="button" class="lab-answer" data-correct="true">106</button>
<button type="button" class="lab-answer" data-correct="false">20</button>
<button type="button" class="lab-answer" data-correct="false">76</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true">20</button>
<button type="button" class="lab-answer" data-correct="false">26</button>
<button type="button" class="lab-answer" data-correct="false">60</button>
<button type="button" class="lab-answer" data-correct="false">8.4</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
```{webr}
#| edit: true
#| min-lines: 4
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false">Yes, to the left</button>
<button type="button" class="lab-answer" data-correct="false">No, the median seems pretty centered</button>
<button type="button" class="lab-answer" data-correct="true">Yes, to the right</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 11</h4><p>What is the median for oldpeak?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false">1.60</button>
<button type="button" class="lab-answer" data-correct="false">0</button>
<button type="button" class="lab-answer" data-correct="false">1.04</button>
<button type="button" class="lab-answer" data-correct="true">0.8</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
<section class="lab-quiz" data-lab-quiz><h4>Question 12</h4><p>What is the IQR of oldpeak?</p>
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false">2</button>
<button type="button" class="lab-answer" data-correct="true">1.60</button>
<button type="button" class="lab-answer" data-correct="false">0</button>
<button type="button" class="lab-answer" data-correct="false">0.24</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="true">Yes, the median and IQR for females is higher</button>
<button type="button" class="lab-answer" data-correct="false">No, they might as well be the same boxplot</button>
<button type="button" class="lab-answer" data-correct="false">No, the difference is not statistically significant</button>
<button type="button" class="lab-answer" data-correct="false">Yes, the difference is statistically significant</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
...
<div class="lab-answers"><button type="button" class="lab-answer" data-correct="false">No, the difference is not statistically significant</button>
<button type="button" class="lab-answer" data-correct="false">No, the medians are almost exactly the same</button>
<button type="button" class="lab-answer" data-correct="false">Yes, the difference is statistically significant</button>
<button type="button" class="lab-answer" data-correct="true">Yes, the median, Q1, and Q3 are higher for the Yes group</button></div>
<div class="lab-feedback" aria-live="polite"></div></section>
## Summary 
